    ...
    <BackgroundBeamsWithCollision className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 md:pt-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full text-center relative z-10 px-2 sm:px-4">
          ...
          {/* Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 animate-fade-in delay-100 leading-tight">
            <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
              Master Your
            </span>
            <br />
            <div className="relative mx-auto inline-block w-max drop-shadow-md">
              <div className="absolute left-0 top-[1px] text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-violet-400 to-pink-400 py-2 sm:py-4">
                Interview Skills
              </div>
              <div className="relative text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-violet-400 to-pink-400 py-2 sm:py-4">
                Interview Skills
              </div>
            </div>
          </h1>
          ...
          {/* Subtitle */}
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-10 sm:mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-in delay-200 px-2 sm:px-6">
